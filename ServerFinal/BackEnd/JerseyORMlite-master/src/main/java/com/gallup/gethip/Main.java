...
public class Main {
	...
	private static void createDatabaseConnection(){
		String databaseUrl = "jdbc:mysql://127.0.0.1:3306/?user=root";
	...
	private static void buildDaos(){
		try {
			DataSourceManager.addDao(home.class);
			DataSourceManager.addDao(systemtotal.class);
			DataSourceManager.addDao(trashcollected.class);
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
