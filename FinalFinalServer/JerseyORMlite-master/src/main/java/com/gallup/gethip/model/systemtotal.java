...
public class systemtotal {
	...
	public systemtotal(int ID, double WeeklyTrashTotal, double DailyTrashTotal, double MonthlyTrashTotal, double YearlyTrashTotal, double LifetimeTrashTotal, int MonthlyAccounts, int DailyAccounts, int YearlyAccounts, int LifetimeAccounts, int WeeklyAccounts){
